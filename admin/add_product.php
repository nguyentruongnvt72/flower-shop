                        ...
                        <div class="col-lg-7">
                            <div class="well">
                                <form action="add_product.php" method="post" name="form" enctype="multipart/form-data">
                                    ...
                                    <p>Mô Tả</p>
                                    <textarea class="thumbnail form-control" name="details" id="details" style="width:100%; height:100px" placeholder="Mô tả sản phẩm này .." required></textarea>
                                    <p>Thêm Ảnh</p>
                            ...
                            <div class="well">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="price" id="price" placeholder="0.000 đ" required>
                                </div><br>
